...
router.post('/unsubscribeAll', Permission('user'), NotificationController.unsubscribeAll);
...
router.get('/getNotifications/:notificationId', Permission('user'), NotificationController.readNotification);
